...
class SidemenuController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        {
            menuOptions = ["Home","Add Recipient","Transaction Status","Payment Limitation","Reset Password","Upload File"]
            menuOptionsIcon = [UIImage(named: "home_green")!,UIImage(named: "addRecipient")!,UIImage(named: "transactionStatus")!,UIImage(named: "paymentlimit")!,UIImage(named: "password")!,UIImage(named: "upload")!]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        else if(menuOptions[indexPath.row] == "Transaction Status")
        {
            NotificationCenter.default.post(name: NSNotification.Name("popToRootViewController"), object: nil)
            NotificationCenter.default.post(name: NSNotification.Name("showTransactionStatus"), object: nil)
            self.revealViewController()?.rightRevealToggle(self)
        }
    }
